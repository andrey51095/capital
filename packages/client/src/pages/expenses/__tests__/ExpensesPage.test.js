...
const mockExpenses = [
  { id: '1', date: '2023-01-01', category: 'Groceries', amount: 50, description: 'Apples' },
  { id: '2', date: '2023-01-02', category: 'Clothing', amount: 100, description: 'Jeans' },
];

const mocks = [
  {
    request: { query: GET_EXPENSES, variables: { filter: {} } },
    result: { data: { getExpenses: mockExpenses } },
  },
  {
    request: { query: CREATE_EXPENSE, variables: { input: { date: '2023-01-03', category: 'Bills', amount: 200 } } },
    result: { data: { createExpense: { id: '3', date: '2023-01-03', category: 'Bills', amount: 200, description: '' } } },
  },
  {
    request: { query: DELETE_EXPENSE, variables: { id: '1' } },
