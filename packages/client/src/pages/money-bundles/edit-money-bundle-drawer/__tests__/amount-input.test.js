...
describe('AmountInput', () => {
  it('renders correctly with initial value and no error', () => {
    render(<AmountInput name="amount" value={100} onChange={() => {}} />);
  ...
  it('adds the value to the current amount when concatenation is confirmed', () => {
    ...
    render(<AmountInput name="amount" value={100} onChange={mockOnChange} />);
  ...
  it('shows error message when error prop is passed', () => {
    render(<AmountInput name="amount" value={100} onChange={() => {}} error="Invalid amount" />);
